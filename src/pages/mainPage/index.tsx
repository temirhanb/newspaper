...
export const MainPage: React.FC = () => {
  ...
  return (
    <div className={"grid sm:grid-cols-1 md:grid-cols-2  lg:grid-cols-3 items-start mx-[10%]"}>
      ...
      <div className={"flex sm:h-[150] h-[300px] w-auto items-center justify-center pt-5 "}>
        <button
          onClick={openCreateForm}
          className={"border-2 p-5 md:w-36  md:h-36 sm:h-20 sm:w-20  flex justify-center items-center rounded-full border-red-300 hover:bg-red-50"}
        >
          <CreateSvg/>
        </button>
      </div>
